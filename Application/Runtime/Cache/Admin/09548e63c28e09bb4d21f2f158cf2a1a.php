...
<![endif]-->
<link href="/Tpproject/Public/Admin/css/H-ui.min.css" rel="stylesheet" type="text/css" />
<link href="/Tpproject/Public/Admin/css/H-ui.admin.css" rel="stylesheet" type="text/css" />
<link href="/Tpproject/Public/Admin/lib/icheck/icheck.css" rel="stylesheet" type="text/css" />
<link href="/Tpproject/Public/Admin/lib/Hui-iconfont/1.0.1/iconfont.css" rel="stylesheet" type="text/css" />
<link href="/Tpproject/Public/Admin/lib/webuploader/0.1.5/webuploader.css" rel="stylesheet" type="text/css" />
<!--[if IE 6]>
...
<div class="pd-20">
	<form action="" method="post" class="form form-horizontal" id="form-article-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-4">
				<input type="text" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'#F<?php echo ($dp["$D('datemin')"]); ?>'})" id="datemax" class="input-text Wdate" style="width:180px;">
			</div>
		</div>
		<div class="row cl">
...
<script type="text/javascript" src="/Tpproject/Public/Admin/lib/jquery/1.9.1/jquery.min.js"></script> 
<script type="text/javascript" src="/Tpproject/Public/Admin/lib/layer/1.9.3/layer.js"></script> 
<script type="text/javascript" src="/Tpproject/Public/Admin/lib/My97DatePicker/WdatePicker.js"></script> 
<script type="text/javascript" src="/Tpproject/Public/Admin/lib/icheck/jquery.icheck.min.js"></script> 
<script type="text/javascript" src="/Tpproject/Public/Admin/lib/Validform/5.3.2/Validform.min.js"></script> 
<script type="text/javascript" src="/Tpproject/Public/Admin/lib/webuploader/0.1.5/webuploader.min.js"></script> 
<script type="text/javascript" src="/Tpproject/Public/Admin/lib/ueditor/1.4.3/ueditor.config.js"></script>
<script type="text/javascript" src="/Tpproject/Public/Admin/lib/ueditor/1.4.3/ueditor.all.min.js"> </script>
<script type="text/javascript" src="/Tpproject/Public/Admin/lib/ueditor/1.4.3/lang/zh-cn/zh-cn.js"></script>
<script type="text/javascript" src="/Tpproject/Public/Admin/js/H-ui.js"></script> 
<script type="text/javascript" src="/Tpproject/Public/Admin/js/H-ui.admin.js"></script> 
