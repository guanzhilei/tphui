...
<script type="text/javascript">
    var table = $('#datatable').dataTable({
        ...
        "columns": [
            ...
            {"bSortable": false, "data": "wm_id", "mRender": function(data, type, full) {
                return '<a href ="/index.php/Admin/Wuser/DeleteAcceptanceProductData/id/'+data+'/flag/DeleteAcceptanceProductInfo"  class="ext_btn" onclick="return delSingle();"><span class="add"></span>删除</a>';
            }
            }
        ],
        "oLanguage": { //国际化配置
