		...
		<li class="dropDown dropDown_hover"><a href="#" class="dropDown_A">admin <i class="Hui-iconfont">&#xe6d5;</i></a>
			<ul class="dropDown-menu radius box-shadow">
				...
				<script>
					...
					function exit(){
						  if(confirm("你的，确定退出来啊"))
   							top.location.href="<?php echo U('main/exits');?>";
					}
				</script>
			</ul>
		</li>
...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-product">
			...
			<dd>
				<ul>
					<li><a _href="<?php echo U('Product/product_brand');?>" href="javascript:void(0)">品牌管理</a></li>
					<li><a _href="<?php echo U('Product/product_category');?>" href="javascript:void(0)">分类管理</a></li>
					<li><a _href="<?php echo U('Product/product_list');?>" href="javascript:void(0)">产品管理</a></li>
				</ul>
			</dd>
		</dl>
		&lt;!&ndash;<dl id="menu-page">
		...
		<dl id="menu-admin">
			...
			<dd>
				<ul>
					<li><a _href="<?php echo U('Admins/admin_role');?>" href="javascript:void(0)">角色管理</a></li>
					<li><a _href="<?php echo U('Admins/admin_permission');?>" href="javascript:void(0)">权限管理</a></li>
					<li><a _href="<?php echo U('Admins/admin_list');?>" href="javascript:void(0)">管理员列表</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-tongji">
		...
		<dl id="menu-system">
			...
			<dd>
				<ul>
					<li><a _href="<?php echo U('System/system_base');?>" href="javascript:void(0)">系统设置</a></li>
					<!--这里跳过一个功能直接写提交的。也就是说我没有完成那个system_category到system_category_add页面跳转-->
					<li><a _href="<?php echo U('System/system_category');?>" href="javascript:void(0)">栏目管理</a></li>
					
					<li><a _href="<?php echo U('System/system_type');?>" href="javascript:void(0)">类型管理</a></li>
					
					<li><a _href="<?php echo U('System/system_data');?>" href="javascript:void(0)">数据字典</a></li>
					<li><a _href="<?php echo U('System/system_shielding');?>" href="javascript:void(0)">屏蔽词</a></li>
					<li><a _href="<?php echo U('System/system_log');?>" href="javascript:void(0)">系统日志</a></li>
				</ul>
			</dd>
		</dl>
        <dl id="menu-weixin">
            ...
            <dd>
                <ul>
                    <li><a _href="<?php echo U('Weixin/menu_list');?>" data-title="菜单管理" href="javascript:void(0)">菜单管理</a></li>
                    <li><a _href="<?php echo U('Wuser/user_list');?>" data-title="用户管理" href="javascript:void(0)">用户管理</a></li>

                    <li><a _href="<?php echo U('System/system_type');?>" href="javascript:void(0)">消息群发</a></li>
                </ul>
            </dd>
        </dl>
	</div>
	...
	<div id="Hui-tabNav" class="Hui-tabNav">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active"><span title="我的桌面" data-href="<?php echo U('main/welcome');?>">我的桌面</span><em></em></li>
			</ul>
		</div>
